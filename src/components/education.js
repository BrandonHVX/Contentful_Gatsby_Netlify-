...
<section id="services" class="services ">
      <div class="container" data-aos="fade-up">
          ...
          <hr className="divider mb-4" />
					<h2 class="mrb-25">Our innovative program is set up to <span class="display-font"> build skill sets </span> that expand  <span class="display-font">beyond the classroom and into the workforce.</span></h2>
